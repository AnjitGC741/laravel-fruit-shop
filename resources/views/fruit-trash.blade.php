...
<body>
    ...
    <button class="btn btn-primary" ><a href="{{url('/')}}" style="color: white;text-decoration:none">Log out</a></button>
    ...
    <div class="tableBox">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><a href="{{url('forceDelete/'.$value->id)}}"><button class="btn btn-danger"> Force Delete</button></a></td>

                <td><a href="{{url('restore/'.$value->id)}}"><button  class="btn btn-warning">Restore</button></a></td>
